...
function s.filter(c,e,tp)
	return not c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsSetCard(0xa008) and c:IsCanBeSpecialSummoned(e,0,tp,true,false) and Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK,0,1,nil,c:GetAttribute())
end
