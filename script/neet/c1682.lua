...
s.listed_series={0x153,0x156,0x155}
...
function s.spfilter(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsSetCard(0x153)
end
...
function s.filter(c)
	return (c:IsSetCard(0x155) or c:IsSetCard(0x156)) and c:IsMonster() and c:IsAbleToHand() 
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if #hg>0 and Duel.SelectYesNo(1-tp,aux.Stringid(id,0)) then
