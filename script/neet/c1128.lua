...
function s.spfilter(c,e,tp)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:IsRace(RACE_SPELLCASTER) and c:IsDefense(1500) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.spfilter1(c,e,tp)
	return c:IsCode(19327348) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
