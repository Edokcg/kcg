...
function s.cfilter(c,tp)
	return c:IsSummonPlayer(1-tp) and c:IsSummonLocation(LOCATION_EXTRA+LOCATION_DECK)
end
...
function s.thfilter(c)
	return (c:IsStatus(STATUS_SUMMON_TURN) or c:IsStatus(STATUS_SPSUMMON_TURN)) and c:IsAbleToHand()
end
