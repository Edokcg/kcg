...
function s.spfilter(c,e,tp)
	...
	return c:IsFaceup() and c:GetEquipTarget():IsSetCard(SET_MEKLORD) and c:IsOriginalType(TYPE_MONSTER) end   
end
...
function s.thfilter4(c)
	return c:IsCode(170) and c:IsSSetable()
end
