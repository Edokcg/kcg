...
function s.spfilter(c,e,tp)
	return c:IsCode(100000051,100000052,100000053,100000054) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function s.rescon(sg,e,tp,mg)
	return sg:IsExists(Card.IsCode,1,nil,100000051) and sg:IsExists(Card.IsCode,1,nil,100000052) and sg:IsExists(Card.IsCode,1,nil,100000053) and sg:IsExists(Card.IsCode,1,nil,100000054)
end
