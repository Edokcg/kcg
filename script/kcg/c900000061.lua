...
function s.lvop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:GetLevel()>=7 then c:SetCardData(1, 37267041)
	elseif c:GetLevel()>=5 then c:SetCardData(1, 74388798)
	elseif c:GetLevel()>=4 then c:SetCardData(1, 15180041)
	elseif c:GetLevel()>=3 then c:SetCardData(1, 1995985)
	elseif c:GetLevel()>=1 then c:SetCardData(1, 39321065) end
