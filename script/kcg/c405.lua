...
s.listed_names={149,8124921,44519536,70903634,7902349,33396948}
s.fit_monster={149,8124921,44519536,70903634,7902349,33396948}
...
function s.filter(c,e,tp)
	return c:IsCode(149) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,false,true)
end
