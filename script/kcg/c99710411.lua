...
if not ModeGame_1 then
    ...
    pack={}
        ...
        --extra
        --101: shooting quaser, 100: shooting star, 511001963: formula synchro
        pack[3]={
			14017402,371,511000774,7841112,511001658,2322421,74860293,44508094,18013090,511027027,511001956,42810973,511015124,46195773,511001982,53981499,511001516,511010534,511001517,511600105,511009416,511021003,511001983,29071332
		}
        --spell
        --26194151: nacro synchro
        pack[4]={
			43422537,72767833,511002846,2295440,511013016,511002844,52128900,511600013,51630558,511010537,511000754,32663969,79068663,6178850,94303232,511010532,73048641,49267971,75652080,511000749
		}
        --trap
        --513000056: converging wish
        pack[5]={
			5609226,14507213,16674846,17521642,21636650,24268052,24545464,30123142,36280194,42079445,47264717,53656677,55465441,62878208,67630339,73729209,92450185,94484482,94634433,96700602,98427577,511000623,511002519,511002520,511002552,511002879,511002911,511004111,511010535,511018015,810000006,810000057,34149830,79205581,98273947,511013017
		}
		...
		for p=z,o do
			...
			for team=1,counts[p] do
				...
				-- Duel.SendtoDeck(Duel.GetFieldGroup(p,0xff,0),nil,-2,REASON_RULE) --exile all cards for all players
                    ...
                    --AddCardSpecial(p,team,{513000056},100,LOCATION_DECK,LOCATION_EXTRA)
                    --AddCardSpecial(p,team,{100,511001658,101,371,511000774},511001963,LOCATION_EXTRA,LOCATION_EXTRA)
