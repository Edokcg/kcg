...
function s.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,nil,2,4,s.ovfilter,aux.Stringid(13703,0))
	c:EnableReviveLimit()
...
s.listed_names={41418852,78625448}
...
function s.ovfilter(c)
	return c:IsFaceup() and c:IsCode(78625448) and Duel.IsExistingMatchingCard(s.damfilter,0,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
end
