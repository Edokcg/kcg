--ズババナイト
function c376.initial_effect(c)
	--destroy
	...
	e1:SetTarget(c376.tg)
	e1:SetOperation(c376.op)
	c:RegisterEffect(e1)
end
function c376.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	local d=Duel.GetAttackTarget()
	if chk ==0 then	return Duel.GetAttacker()==e:GetHandler()
		and d~=nil and d:IsPosition(POS_FACEUP_DEFENSE) and d:IsDestructable() end
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,d,1,0,0)
end
function c376.op(e,tp,eg,ep,ev,re,r,rp)
	local d=Duel.GetAttackTarget()
