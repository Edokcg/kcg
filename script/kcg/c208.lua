...
function s.reverse_chain(e,tp,eg,ep,ev,re,r,rp)
   local code={511001126,55144522,62015408,58851034,14558127,59438930,67750322,73642296,77538567,10045474,97268402}
   local ttp = e:GetOwner():GetControler()
...
function s.reverse_chain2(e,tp,eg,ep,ev,re,r,rp)
   ...
   local ttp = e:GetOwner():GetControler()
   if Duel.GetFieldGroupCount(ttp,LOCATION_HAND,0)<5 then
      if Duel.GetFieldGroupCount(ttp,LOCATION_HAND,0)>3 then 
         code={55144522}
      end
