...
s.listed_names={77506119,13995824}

function s.filter(c,e,tp)
	return c:IsCode(77506119,13995824) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
		and (Duel.GetLocationCountFromEx(tp,tp,nil,c)>0 or (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and not c:IsHasEffect(EFFECT_NECRO_VALLEY)))
end
