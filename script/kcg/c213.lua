...
function s.thop2(e,tp,eg,ep,ev,re,r,rp)
    ...
    elseif not aux.burstlist[code] then
        ...
        c:SetEntityCode(aux.burstlist[code],nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,true)
        return
    end
    if addset then
    ...
    aux.CopyCardTable(c,"listed_names",CARD_ASSAULT_MODE,code)
    c.__index.assault_mode=code
	local tec2 = {c:GetTriggerEffect()}
	if tec2 then
