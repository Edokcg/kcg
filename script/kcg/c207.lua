...
s.listed_names={511015104, 511015105}
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.BreakEffect()
	local g=Duel.GetMatchingGroup(function(sc) return sc:IsType(TYPE_XYZ) and sc:IsXyzSummonable(nil,sg,2,2) end,tp,LOCATION_EXTRA,0,nil)
	if #g>0 then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
