...
s.listed_names={4545683,100000062,100000063,100000064,100000065}
...
function s.filter(c,e,tp)
	return c:IsCode(4545683,100000062,100000063,100000064,100000065) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function s.rescon(sg,e,tp,mg)
	return sg:IsExists(Card.IsCode,1,nil,4545683) and sg:IsExists(Card.IsCode,1,nil,100000062) and sg:IsExists(Card.IsCode,1,nil,100000063) and sg:IsExists(Card.IsCode,1,nil,100000064) and sg:IsExists(Card.IsCode,1,nil,100000065)
end
