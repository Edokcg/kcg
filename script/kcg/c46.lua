...
function s.initial_effect(c)
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,CARD_SUMMONED_SKULL,s.ffilter2)
	--Change name
...
s.listed_names={281,CARD_SUMMONED_SKULL}
s.material={281,CARD_SUMMONED_SKULL}

function s.ffilter2(c)
	return c:IsAttribute(ATTRIBUTE_DARK) or c:IsCode(281)
end
