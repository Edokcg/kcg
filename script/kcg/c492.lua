...
function s.initial_effect(c)
	...
	c:RegisterEffect(e42,false,EFFECT_MARKER_DETACH_XMAT)
	...
	c:RegisterEffect(e62,false,EFFECT_MARKER_DETACH_XMAT)
end
s.xyz_number=53
