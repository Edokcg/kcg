...
function s.initial_effect(c)
	...
	e3:SetValue(function (e) return math.min(e:GetHandler():GetOverlayGroup():FilterCount(Card.IsType,nil,TYPE_MONSTER)-1,0) end)
	c:RegisterEffect(e3)
...
function s.target(e,tp,eg,ev,ep,re,r,rp,chk)
	...
	local tg=Duel.SelectTarget(tp,s.filter,tp,LOCATION_MZONE,0,1,1,nil,e:GetHandler())
