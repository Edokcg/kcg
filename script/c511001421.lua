...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.GetMatchingGroup(s.filter,tp,LOCATION_MZONE,0,nil,tp)
...
function s.cond(e)
	return Duel.IsExistingMatchingCard(s.filter2,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,e:GetHandler(),e:GetHandler():GetCode())
end